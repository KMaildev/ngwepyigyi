...
class Job_seekerController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","phone","registration_date","nrc_no","date_of_birth","age","gender","health_status","height","weight","education","skill","language","current_address","passport","expire_date");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","email","phone","registration_date","nrc_no","date_of_birth","age","gender","health_status","height","weight","education","skill","language","current_address","passport","expire_date");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
